...
- configurable color options for:
  ...
  - tick
- (don't) show border, cast time, spell icon, raid marker, target of cast
- font and font size selection, powered by [LibSharedMedia](https://www.curseforge.com/wow/addons/libsharedmedia-3-0)
